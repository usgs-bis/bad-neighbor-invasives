...
There are a total of `r sum(comb_all_results$bad_neighbor_count)` "Bad Neighbor" species documented in the Lower 48 United States.  The table below describes the results by taxon group as total and the relative contribution, or threat, for each group.
