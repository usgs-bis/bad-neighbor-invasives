...
2) A string hierarchy_homonym_string in the form: `"*\\-179913\\-*"`.  A predefined list is stored in: `data/heirarchy_strings.csv`, and several groups of related taxa are in files ending in `"*_heirarchy_strings.csv"`.  The list of taxa is currently restricted to the best represented taxa in BISON.
